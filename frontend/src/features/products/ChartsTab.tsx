...
// Разрыв тиков ставки: воркер тикает часто (несколько раз в сутки), поэтому
// достаточно большого порога — «нет тика больше полутора суток» уже похоже
// на реальный простой, а не на обычный интервал между циклами.
const TICK_MAX_GAP_SEC = 36 * 60 * 60;
