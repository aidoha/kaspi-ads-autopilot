...
def require_user(request: Request) -> str:
    ...
    Осознанно НЕ редиректим на /login: фронт ходит сюда через fetch, и
    редирект на HTML отдал бы ему разметку вместо данных — ошибка бы
    всплыла как невнятный сбой парсинга, а не как «нужен вход».
    """
